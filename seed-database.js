...
const seedUsers = [
  ...
  async function seedHomerMuseums(categoryIds) {
    ...
    const museum1 = await ensureMuseum({
      userid: homerId, title: "Modern Art Gallery", description: "Contemporary art from the 21st century",
      categoryId: categoryIds.artId, latitude: 52.489471, longitude: -1.898575
    });
    
    const museum2 = await ensureMuseum({
      userid: homerId, title: "World War Museum", description: "WW1 and WW2 artifacts and stories",
      categoryId: categoryIds.historyId, latitude: 52.491234, longitude: -1.895432
    });
    
    const museum3 = await ensureMuseum({
      userid: homerId, title: "Natural History Museum", description: "Dinosaurs, fossils, and natural wonders",
      categoryId: categoryIds.scienceId, latitude: 52.487654, longitude: -1.901234
    });
    
    const museum4 = await ensureMuseum({
      userid: homerId, title: "Aviation Museum", description: "History of flight and aircraft",
      categoryId: categoryIds.historyId, latitude: 52.494321, longitude: -1.889876
    });
    
    const museum5 = await ensureMuseum({
      userid: homerId, title: "Space Exploration Center", description: "Journey through space history",
      categoryId: categoryIds.scienceId, latitude: 52.485678, longitude: -1.903456
    });
  ...
  async function seedMargeMuseums(categoryIds) {
    ...
    const museum1 = await ensureMuseum({
      userid: margeId, title: "Classical Art Museum", description: "Renaissance and classical masterpieces",
      categoryId: categoryIds.artId, latitude: 52.488123, longitude: -1.897654
    });
    
    const museum2 = await ensureMuseum({
      userid: margeId, title: "Ancient Civilizations", description: "Egypt, Greece, and Rome artifacts",
      categoryId: categoryIds.historyId, latitude: 52.492345, longitude: -1.894321
    });
    
    const museum3 = await ensureMuseum({
      userid: margeId, title: "Marine Biology Center", description: "Ocean life and conservation",
      categoryId: categoryIds.scienceId, latitude: 52.486789, longitude: -1.902345
    });
    
    const museum4 = await ensureMuseum({
      userid: margeId, title: "Impressionist Gallery", description: "Monet, Renoir, and French impressionists",
      categoryId: categoryIds.artId, latitude: 52.490123, longitude: -1.896789
    });
  ...
  async function seedLisaMuseums(categoryIds) {
    ...
    const museum1 = await ensureMuseum({
      userid: lisaId, title: "Environmental Science Center", description: "Climate change and sustainability",
      categoryId: categoryIds.scienceId, latitude: 52.487890, longitude: -1.900123
    });
    
    const museum2 = await ensureMuseum({
      userid: lisaId, title: "Jazz Museum", description: "History of jazz music and legends",
      categoryId: categoryIds.artId, latitude: 52.493456, longitude: -1.891234
    });
    
    const museum3 = await ensureMuseum({
      userid: lisaId, title: "Women's History Museum", description: "Celebrating women's achievements",
      categoryId: categoryIds.historyId, latitude: 52.489012, longitude: -1.899876
    });
  ...
  async function seedExhibitions(museums) {
    ...
    await ensureExhibition(museums.homer[0]._id, {
      title: "Abstract Expressions", description: "Modern abstract paintings",
      startDate: "2026-04-01", endDate: "2026-06-30"
    });
    await ensureExhibition(museums.homer[0]._id, {
      title: "Digital Art Revolution", description: "NFTs and digital creativity",
      startDate: "2026-07-01", endDate: "2026-09-30"
    });
    
    await ensureExhibition(museums.homer[1]._id, {
      title: "D-Day Stories", description: "Personal accounts from Normandy",
      startDate: "2026-05-01", endDate: "2026-08-31"
    });
    await ensureExhibition(museums.homer[1]._id, {
      title: "Home Front Life", description: "Civilian life during wartime",
      startDate: "2026-09-01", endDate: "2026-12-31"
    });
    
    await ensureExhibition(museums.homer[2]._id, {
      title: "Age of Dinosaurs", description: "Jurassic period fossils",
      startDate: "2026-03-01", endDate: "2026-12-31"
    });
    
    await ensureExhibition(museums.homer[3]._id, {
      title: "Wright Brothers Legacy", description: "First powered flight",
      startDate: "2026-06-01", endDate: "2026-10-31"
    });
    
    await ensureExhibition(museums.homer[4]._id, {
      title: "Moon Landing 60 Years", description: "Apollo 11 anniversary",
      startDate: "2026-07-20", endDate: "2026-12-31"
    });
    
    // Marge's museums exhibitions
    await ensureExhibition(museums.marge[0]._id, {
      title: "Renaissance Masters", description: "Da Vinci and Michelangelo",
      startDate: "2026-04-15", endDate: "2026-08-15"
    });
    await ensureExhibition(museums.marge[0]._id, {
      title: "Baroque Beauty", description: "17th century European art",
      startDate: "2026-09-01", endDate: "2027-01-31"
    });
    
    await ensureExhibition(museums.marge[1]._id, {
      title: "Pharaohs of Egypt", description: "Tutankhamun and ancient rulers",
      startDate: "2026-05-01", endDate: "2026-10-31"
    });
    
    await ensureExhibition(museums.marge[2]._id, {
      title: "Coral Reefs in Crisis", description: "Ocean conservation efforts",
      startDate: "2026-06-08", endDate: "2026-12-31"
    });
    
    await ensureExhibition(museums.marge[3]._id, {
      title: "Monet's Water Lilies", description: "Impressionist garden series",
      startDate: "2026-03-01", endDate: "2026-07-31"
    });
    
    // Lisa's museums exhibitions
    await ensureExhibition(museums.lisa[0]._id, {
      title: "Climate Solutions", description: "Renewable energy innovations",
      startDate: "2026-04-22", endDate: "2026-11-30"
    });
    await ensureExhibition(museums.lisa[0]._id, {
      title: "Plastic Ocean", description: "Marine pollution awareness",
      startDate: "2026-06-05", endDate: "2026-12-31"
    });
    
    await ensureExhibition(museums.lisa[1]._id, {
      title: "Miles Davis Tribute", description: "The prince of jazz",
      startDate: "2026-05-26", endDate: "2026-09-26"
    });
    
    await ensureExhibition(museums.lisa[2]._id, {
      title: "Suffragette Movement", description: "Women's voting rights history",
      startDate: "2026-03-08", endDate: "2026-08-26"
    });
  }
